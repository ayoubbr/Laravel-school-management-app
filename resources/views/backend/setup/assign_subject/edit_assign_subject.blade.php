                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                                    ...
                                                    <div class="delete_whole_extra_item_add"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-2" style="padding-top: 25px;">
                                                                <span
                                                                    class=" text-white  text-white btn btn-success addeventmore"><i
                                                                        class="fa fa-plus-circle"></i> </span> <span
                                                                    class=" text-white  text-white btn btn-danger removeeventmore"><i
                                            ...
                                            <div class="text-xs-right">
                                                <input type="submit" class=" text-white  text-white btn btn-info mb-5"
                                                    value="Update">
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="whole_extra_item_add" id="whole_extra_item_add">
            <div class="delete_whole_extra_item_add" id="delete_whole_extra_item_add">
                <div class="form-row">
                    ...
                    <div class="col-md-2" style="padding-top: 25px;">
                        <span class=" text-white btn btn-success addeventmore"><i
                                class="fa fa-plus-circle"></i> </span>
                        <span class=" text-white btn btn-danger removeeventmore"><i
                                class="fa fa-minus-circle"></i> </span>
                    </div><!-- End col-md-2 -->
                </div>
            </div>
