                    ...
                    <div class="box overflow-hidden pull-up">
                        <div class="box-body">
                            <div class="icon bg-info-light rounded w-60 h-60">
                                <i class="text-info mr-0 font-size-24 text-white mdi mdi-sale"></i>
                            </div>
                            <div>
                                <p class="text-mute mt-20 mb-0 font-size-16">Sales Lost</p>
                                <h3 class=" mb-0 font-weight-500">$1,250 <small
                    ...
                    <div class="box overflow-hidden pull-up">
                        <div class="box-body">
                            <div class="icon bg-danger-light rounded w-60 h-60">
                                <i class="text-danger mr-0 font-size-24 text-white mdi mdi-phone-incoming"></i>
                            </div>
                            <div>
                                <p class="text-mute mt-20 mb-0 font-size-16">Inbound Call</p>
                                <h3 class=" mb-0 font-weight-500">1,460 <small
                    ...
                    <div class="box overflow-hidden pull-up">
                        <div class="box-body">
                            <div class="icon bg-success-light rounded w-60 h-60">
                                <i class="text-success mr-0 font-size-24 text-white mdi mdi-phone-outgoing"></i>
                            </div>
                            <div>
                                <p class="text-mute mt-20 mb-0 font-size-16">Outbound Call</p>
                                <h3 class=" mb-0 font-weight-500">1,700 <small
                                        class="text-success"><i class="fa fa-caret-up"></i> +0.5%</small></h3>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="box overflow-hidden pull-up">
                        <div class="box-body">
                            <div class="icon bg-light rounded w-60 h-60">
                                <i class=" mr-0 font-size-24 text-white mdi mdi-chart-line"></i>
                            </div>
                            <div>
                                <p class="text-mute mt-20 mb-0 font-size-16">Total Revune</p>
                                <h3 class=" mb-0 font-weight-500">$4,500k <small
                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                <table class="table no-border">
                                    <thead>
                                        <tr class="text-uppercase bg-darkest">
                                            <th style="min-width: 250px"><span
                                                    class="">products</span></th>
                                            <th style="min-width: 100px"><span class="text-fade">price</span>
                                            </th>
                                        ...
                                        <tr>
                                            <td class="pl-0 py-8">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <a href="#"
                                                            class=" font-weight-600 hover-primary mb-1 font-size-16">Vivamus
                                                            consectetur</a>
                                            ...
                                            <td class="text-right">
                                                <a href="#"
                                                    class="waves-effect waves-light btn btn-info btn-circle mx-5"><span
                                                        class="text-white mdi mdi-bookmark-plus"></span></a>
                                                <a href="#"
                                                    class="waves-effect waves-light btn btn-info btn-circle mx-5"><span
                                                        class="text-white mdi mdi-arrow-right"></span></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="pl-0 py-8">
